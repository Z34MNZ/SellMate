...
const SellerProfile = () => {
  ...
  const { user } = useAuth();
  const [profile, setProfile] = useState({ name: "", email: "", storeName: "" });
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <form className="space-y-6 max-w-lg mx-auto bg-white p-8 rounded shadow" onSubmit={handlePasswordChange}>
        <div className="flex flex-col items-center mb-6">
          <img
            src="https://ui-avatars.com/api/?name=Seller&background=0D8ABC&color=fff"
            alt="Avatar"
        ...
        <div>
          ...
          <input className="w-full border rounded p-2" type="text" value={profile.storeName} readOnly />
        </div>
        <hr className="my-6" />
        <div>
